...
from scrapes.models import PlatformScrapeSettings
...
def get_data(instance):
    ...
    if getattr(instance, 'single_scrape_platform_id',''):
        ...
        scrape_data = PlatformScrapeSettings.objects.filter(id=instance.single_scrape_platform_id)
    else:
        scrape_data = PlatformScrapeSettings.objects.all()
...
class PlatformSpider(scrapy.Spider):
    ...
    custom_settings = {
        'ITEM_PIPELINES': {
           'scrape_module.pipelines.SaveLinkPipeline': 301,
        },
